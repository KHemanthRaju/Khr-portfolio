export const profile = {
  name: "Hemanth Raju Koneti",
  shortName: "Hemanth Koneti",
  title: "AWS Cloud Developer & Full-Stack Engineer",
  roles: [
    "AWS Cloud Developer",
    "Full-Stack Engineer",
    "AI/ML Enthusiast",
  ...
  yearsOfExperience: 3,
  github: {
    username: "KHemanthRaju",
    url: "https://github.com/KHemanthRaju",
    repos: 151,
    followers: 682,
  },
  linkedin: {
    url: "https://linkedin.com/in/khemanthraju",
    username: "khemanthraju",
  },
  resumeUrl: "/resume/Hemanth_Raju_K_Resume.pdf",
};
